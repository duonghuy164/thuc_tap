...
@section('content')
  <section class="content">
   {{--  {{ Breadcrumbs::render('addcategory') }} --}}
    ...
    <form method="POST" action="{{ route('system_admin.color.store') }}">
      {{ csrf_field() }}
      @if ($errors->all())
        <div class="note note-danger"><p>Vui lòng điền đầy đủ thông tin</p></div>
      @else 
        <div class="note note-success"><p>Bạn đang tạo màu sắc mới</p></div>
      @endif
      <div class="row">
        <div class="col-md-9">
            ...
            <div class="tab-content">
              <div class="tab-pane active show" id="tab_detail">
                <div class="form-group">
                  <label for="title" class="control-label required">Tên màu sắc</label>
                  <input class="form-control" placeholder="Nhập tên màu sắc" data-counter="120" name="title" type="text" id="title" value="{{ old('title') }}">
