        ...
        <div class="box">
          <div class="box-header with-border">
            <div class="pull-right">
              ...
              <div class="btn-group pull-right" style="margin-right: 10px">
                <a href="{{route('system_admin.color.create')}}" class="btn btn-sm btn-success" title="New">
                ...
                @if (count($color) >0)
                  @foreach($color as $color)
                    <tr>
                      ...
                      <td>
                        <a href="{{route('system_admin.color.edit',['id'=>$color->id])}}" class="btn btn-icon btn-sm btn-primary tip">
                          <i class="fa fa-eye"></i>
                        </a>
