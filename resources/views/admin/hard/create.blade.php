...
@section('content')
  <section class="content">
   {{--  {{ Breadcrumbs::render('addcategory') }} --}}
    ...
    <form method="POST" action="{{ route('system_admin.hard.store') }}">
      {{ csrf_field() }}
      @if ($errors->all())
        ...
        <div class="col-md-9">
          <div class="tabbable-custom">
            <ul class="nav nav-tabs ">
              <li class="nav-item">
                <a href="#tab_detail" class="nav-link active show" data-toggle="tab">Chi tiết ổ cứng</a>
              </li>      
            </ul><!-- end.nav-tabs -->
            <div class="tab-content">
              <div class="tab-pane active show" id="tab_detail">
                <div class="form-group">Tên ổ Cứng</label>
                  <input class="form-control" placeholder="Nhập tên ổ cứng" data-counter="120" name="title" type="text" id="title" value="{{ old('title') }}">
